...
const AboutPage = () => {
  ...
  return (
    <div className="font-home">
      ...
      >
        ...
        <div className="w-[50%] flex flex-col items-center gap-4 relative z-20">
          ...
          <span className="flex flex-row justify-between gap-9 ">
            ...
            <a onClick={redirectToContact} className="text-lg font-semibold text-orange-500">About</a>
          </span>
        </div>
      </section>
      ...
      <section
        id="welcome-section"
        className="w-full h-[550px] bg-white flex flex-row items-center justify-between py-20 px-20"
      >
        <div
          id="left"
      ...
      <section
        id="meet-section"
        className="w-full h-[600px] flex flex-col items-center gap-10 py-10 bg-white"
      >
        <span className="flex flex-col items-center justify-center gap-5">
          <h3 className="w-[70%] font-extrabold text-center text-stone-900 text-4xl">
