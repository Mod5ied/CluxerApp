			...
			<section className="w-full h-[350px] relative flex flex-col items-center justify-center">
				...
				<div className="w-[50%] flex flex-col items-center gap-4 relative z-20">
					...
					<span className="flex flex-row justify-between gap-9">
						...
						<a onClick={redirectToAbout} className="text-lg font-semibold text-stone-200 hover:text-orange-500">
							About
						</a>
					</span>
				</div>
			...
			<section id="mid" className="flex items-center justify-center w-full py-5">
				<div className="flex flex-col items-center gap-3 w-[70%] ">
					...
					<span className="flex flex-row font-light text-stone-800">
						Blockvault is a registered investment platform providing digital asset investment management services to individuals.
						<p onClick={redirectToSignup} className="text-orange-500 cursor-pointer">
							Signup Now.
						</p>
					</span>

					<form onSubmit={handleSubmit} className="flex flex-col py-4 gap-5 md:w-[450px] h-[350px] ">
						<span className="flex flex-row justify-between w-full gap-5">
							<input type="text" placeholder="Your Name" className="w-[48%] p-3 bg-stone-100 border-4" />
							<input type="text" placeholder="Your Email" className="w-[48%] p-3 bg-stone-100 border-4" />
						</span>

						<input type="text" placeholder="Subject" className="w-full p-3 bg-stone-100 border-4" />
						<textarea name="" placeholder="Message" className="px-3 py-5 bg-stone-100 border-4"></textarea>
